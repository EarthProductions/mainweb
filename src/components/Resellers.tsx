              ...
              <div className="space-y-4">
                <div className="text-center">
                  <p className="text-sm text-muted-foreground mb-4">
                    Neem contact met ons op via e-mail om deel te nemen aan het reseller programma. 
                ...
                <Button 
                  className="w-full" 
                  size="lg"
                  onClick={() => window.open('mailto:order@venturecloud.nl?subject=Interesse in Reseller Programma', '_blank')}
                >
